...
import { GigagoCreateOrderClient } from '../../apps/api/dist/modules/procurement/infrastructure/gigago/gigago.client.js';
...
const runId =
  `ysim-vs-r1-016-${randomBytes(5).toString('hex')}`;
...
const orderAccessToken =
  'runtime-order-access-token-016-'.padEnd(48, 'x');
...
try {
  ...
  const eventId =
    'gpay:event:intent-runtime-016-0001';
