...
const allowedPrefixes = [
  ...
  'database/migrations/20260730030000_vs_r1_003_catalog/',
  'docs/releases/r1/implementation/vs-r1-003/',
  'scripts/vs-r1-003/',
  'tests/vs-r1-003/',
];
...
if (prohibited.length > 0) {
  throw new Error(
    `VS-R1-003 worktree contains prohibited paths: ${prohibited.join(', ')}`,
  );
}
