...
const runId =
  `ysim-vs-r1-013-${randomBytes(5).toString('hex')}`;
...
try {
  ...
  const eventId =
    'gpay:event:intent-runtime-013-0001';
  ...
  evidence.database = {
    ...
    payment_success_outbox: outboxRows.length,
    payment_success_outbox_pending: outbox.published_at === null,
  };
