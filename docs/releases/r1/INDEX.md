...
1. [Release 1 Definition](./RELEASE_1_DEFINITION.md)
2. [Decision Register](./DECISION_REGISTER.md)
3. [Acceptance Checklist](./ACCEPTANCE_CHECKLIST.md)
...
| Package | Status |
|---|---|
| R1D-01 — Release Definition Baseline | Accepted |
