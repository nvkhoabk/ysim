...
Create a reproducible engineering quality pipeline for local and CI execution, including install, lint, typecheck, tests, builds, infrastructure validation, security hygiene checks, and human-readable failure output.
