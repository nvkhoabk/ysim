...
Establish the reproducible local infrastructure baseline for PostgreSQL, Redis, MinIO, and Mailpit with Docker Compose, health checks, named volumes, environment conventions, and verification scripts.
