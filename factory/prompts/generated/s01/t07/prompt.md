...
Provide operational endpoints and API documentation so humans and infrastructure can determine whether the API is alive, ready, correctly configured, and discoverable.
