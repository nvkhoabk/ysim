...
describe('VS-R1-034 read-only delivery operations summary (12)', () => {
  ...
  it('registers and exports the summary providers', () => { expect(moduleSource).toContain('CustomerDeliveryOperationsSummaryRepository'); expect(moduleSource).toContain('CustomerDeliveryOperationsSummaryService'); });
});
